namespace SharedCache.Custom.Caches
{
    ...
    public class SharedCustomDictionaryCache<TKey, TValue> : CustomCache<SharedCustomCacheDictionary<TKey, TValue>>, IDisposable
    {
        ...
        public SharedCustomDictionaryCache(string name, StringCache stringCache, IClearPredicate clearPredicate, ICacheSerializer<TKey> keyCacheSerializer, ICacheSerializer<TValue> valueCacheSerializer, bool clearOnly) : base(name, clearPredicate)
        {
