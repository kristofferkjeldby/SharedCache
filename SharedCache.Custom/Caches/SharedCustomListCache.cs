namespace SharedCache.Custom.Caches
{
    ...
    public class SharedCustomListCache<TValue> : CustomCache<SharedCustomCacheList<TValue>>, IDisposable
    {
        ...
        public SharedCustomListCache(string name, StringCache secondLevelCache, IClearPredicate clearPredicate, ICacheSerializer<TValue> valueCacheSerializer, bool clearOnly) : base(name, clearPredicate)
        {
